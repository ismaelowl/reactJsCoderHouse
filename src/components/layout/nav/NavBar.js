import { Container, Heading, Box, Flex, Button, IconButton, useColorMode, Menu, MenuButton, MenuList, MenuGroup, MenuItem, MenuDivider, Text } from '@chakra-ui/react';
            ...
            <Flex h="80px" gap={6}>
                ...
                <Box w="100%" h="100%" className="list-menu">
                    <Flex h="100%" alignItems="center" justifyContent="space-around">
                        ...
                        <Box>
                            <Link to="/category/nuevosProductos" fontWeight="bold"><Text fontWeight="bold">Nuevos</Text></Link>
                        </Box>
                        <Box>
                            <Link to="/category/productosDestacados" fontWeight="bold"><Text fontWeight="bold">Destacados</Text></Link>
                        </Box>
                        <Box>
