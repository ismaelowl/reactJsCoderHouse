import { Container, Heading, Box, Flex, Link, Button, IconButton, useColorMode, useColorModeValue, Menu, MenuButton, MenuList, MenuGroup, MenuItem, MenuDivider } from '@chakra-ui/react';
            ...
            <Flex h="60px" gap={6} border="1px" borderColor={border} borderRadius="lg" padding="0 30px 0 30px">
                ...
                <Box w="100%" h="100%" className="list-menu">
                    <Flex h="100%" alignItems="center" justifyContent="space-around">
                        ...
                        <Box>
                            <Link fontWeight="bold">Categorias</Link>
                        </Box>
                        <Box>
                            <Link fontWeight="bold">Ofertas</Link>
                        </Box>
                        <Box>
                            <Link fontWeight="bold">Ingresar</Link>
                        </Box>
                    </Flex>
                </Box>
